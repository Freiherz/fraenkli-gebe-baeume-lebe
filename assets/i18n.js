...
window.I18N = {
  de: {
    ...
    'trees.planted': 'Schon {n} Bäumli gepflanzt.',
    'trees.delay': 'alle 10 Min.',
    ...
    'donate.note': 'Die gesammelten Spenden gehen an Tree-Nation, zum Bäume pflanzen. Jede Spende ist freiwillig. Danke, dass du mitpflanzt!',
  ...
  fr: {
    ...
    'trees.planted': 'Déjà {n} petits arbres plantés.',
    'trees.delay': 'toutes les 10 min',
    ...
    'donate.note': 'Les dons récoltés sont reversés à Tree-Nation, qui plante les arbres. Chaque don est volontaire. Merci de planter avec nous !',
  ...
  en: {
    ...
    'donate.note': 'The collected donations are forwarded to Tree-Nation, who plant the trees. Every donation is voluntary. Thank you for planting with us!',
